from agent_config.context import PerformanceContext
...
async def invoke(payload, context):
    if not PerformanceContext.get_response_queue_ctx():
        PerformanceContext.set_response_queue_ctx(StreamingQueue())

    if not PerformanceContext.get_gateway_token_ctx():
        PerformanceContext.set_gateway_token_ctx(await get_gateway_access_token())
