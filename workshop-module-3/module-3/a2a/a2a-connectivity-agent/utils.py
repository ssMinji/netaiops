...
def _get_client_secret(identity_group: str) -> str:
    ...
    Args:
        identity_group: The identity group name (troubleshooting-104398007905-6c3cb980)
    ...
    *,
    ...
    Args:
        ...
        scope_string: space-separated resource server scopes, e.g.
            "log-analytics-gateway-1xa7iugnht/gateway:read log-analytics-gateway-1xa7iugnht/gateway:write"
