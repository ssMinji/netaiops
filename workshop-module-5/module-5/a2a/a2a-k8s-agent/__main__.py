...
from agent_executer import K8sDiagnosticsAgentCoreExecutor
...
async def health_check(request):
    ...
    return JSONResponse({
        ...
        "service": "k8s-diagnostics-agent",
        "agent_arn": agent_arn
    })

def main():
    """Starts the AgentCore K8s Diagnostics Agent A2A server."""
    print("Starting AgentCore K8s Diagnostics Agent A2A server...")
    ...
    try:
        ...
        request_handler = DefaultRequestHandler(
            agent_executor=K8sDiagnosticsAgentCoreExecutor(
                base_url=base_url,
                agent_arn=agent_arn,
