    ...
    def _create_troubleshooting_scenarios(self) -> List[TestScenario]:
        ...
        return [
            TestScenario(
                ...
                query="Can you check connectivity between reporting.examplecorp.com and database.examplecorp.com?",
            ...
            TestScenario(
                ...
                agent_type="TroubleshootingAgent", 
                query="Fix connectivity between reporting.examplecorp.com and database.examplecorp.com",
            ...
            TestScenario(
                ...
                agent_type="TroubleshootingAgent",
                query="Resolve the hostname reporting.examplecorp.com",
            ...
            TestScenario(
                ...
                agent_type="TroubleshootingAgent", 
                query="Check connectivity from reporting.examplecorp.com to database.examplecorp.com on port 3306",
    ...
    def _create_performance_scenarios(self) -> List[TestScenario]:
        ...
        return [
            ...
            TestScenario(
                ...
                agent_type="PerformanceAgent",
                query="Fix retransmission issues on instance for ExampleCorp Imaging Application",
    ...
    def _create_collaborator_agent_scenarios(self) -> List[TestScenario]:
        ...
        return [
            ...
            TestScenario(
                ...
                agent_type="CollaboratorAgent",
                query="Can you check DNS resolution for reporting.examplecorp.com?",
                category="agent_routing",
                expected_tools=["send_message_tool"],
