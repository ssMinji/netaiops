...
def main():
    ...
    try:
        ...
        # Create ticket data
        ticket_data = {
            "subject": "ExampleCorp - Reporting down for Imaging Platform, Triaging using Memory",
            "priority": "medium",
            "description": "Reporting is broken for Imaging Platform. Needed Investigation."
        }
    ...
    print(f"  Title: ExampleCorp - Reporting down for Imaging Platform, Triaging using Memory")
