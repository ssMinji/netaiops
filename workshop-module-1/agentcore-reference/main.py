from agent_config.context import TroubleshootingContext
...
async def invoke(payload, context):
    if not TroubleshootingContext.get_response_queue_ctx():
        TroubleshootingContext.set_response_queue_ctx(StreamingQueue())

    if not TroubleshootingContext.get_gateway_token_ctx():
        TroubleshootingContext.set_gateway_token_ctx(await get_gateway_access_token())
